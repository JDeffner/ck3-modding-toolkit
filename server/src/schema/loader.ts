...
import { CK3_SCHEMA, PREFIX_REFS, REF_FIELDS } from "../../../shared/src/schema/ck3Schema";
import { STRUCTURE_SOURCES } from "../../../shared/src/schema/structures";
import type {
  AmbientScope,
  Ck3SchemaEntry,
  KeySpec,
