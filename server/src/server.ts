...
connection.onInitialize((params: InitializeParams): InitializeResult => {
  ...
  // freqs.json ships at <extensionRoot>/shared/data (sibling of wikidocs/); derive
  // it from wikidocsDir so no new client-side wiring is needed. Fail-soft if empty.
  freqsDir = wikidocsDir ? path.join(path.dirname(wikidocsDir), "shared", "data") : "";
