 ...
 * schema table (shared/src/schema): every schema entry maps one folder to a
...
import type { DefKind, Definition, DefSource, IndexStats } from "../../../shared/src/types";
import { listFiles, walkDir } from "../../../shared/src/fsWalk";
