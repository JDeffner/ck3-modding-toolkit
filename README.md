...
- [jesec/ck3-modding-wiki](https://github.com/jesec/ck3-modding-wiki), the source
  of the bundled fallback token lists in `wikidocs/` (CC BY-SA 3.0, see
  [wikidocs/ATTRIBUTION.md](wikidocs/ATTRIBUTION.md)).
...
[LICENSE](LICENSE). Bundled third-party data keeps its own terms (`wikidocs/` is
CC BY-SA, see [wikidocs/ATTRIBUTION.md](wikidocs/ATTRIBUTION.md)).
